...
## Appendix A: The support@chesscentre Alias

*Note*: At the current time, all email sent to the `support@chesscentre.online` email
alias is copied to all members of the [The Chess Centre Moderation Team][].
