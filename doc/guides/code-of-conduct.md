...
The Chess Centre organisation has a [Code of Conduct][] that *all* contributors are
expected to follow. This code describes the *minimum* behavior expectations
for all contributors.

As a contributor to the Chess Centre organisation, how you choose to act and interact towards your
...
All contributors to The Chess Centre tacitly agree to abide by both the letter and
